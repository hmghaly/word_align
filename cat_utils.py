...
def pre_edit(sent_str,nn_model_obj,first_token_dict,pred_threshold=0.5,freq_threshold=None): #pre-edit a sentence given the first token dict and a neural network model object with prediction
  ...
  if nn_model_obj!=None: pre_edited_sent_tokens,valid_repl=repl_span_phrase(sent_tokens0,new_items,sort_by="wt",min_wt=pred_threshold,min_freq=freq_threshold)
  else: pre_edited_sent_tokens,valid_repl=repl_span_phrase(sent_tokens0,new_items,sort_by="freq",min_wt=0,min_freq=freq_threshold)
...
def pre_edit_html(sent_str,nn_model_obj,first_token_dict,pred_threshold=0.5,freq_threshold=None):
  original_tokens=general.tok(sent_str)
  pre_edited_sent_tokens,valid_repl=pre_edit(sent_str,nn_model_obj,first_token_dict,pred_threshold=pred_threshold,freq_threshold=freq_threshold)
