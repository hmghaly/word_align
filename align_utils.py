...
def get_index_matching(src_tokens0,trg_tokens0,src_index0,trg_index0,max_phrase_length=4,min_intersection_count=10): #match src/trg phrase based on index matching intersection/ratio
